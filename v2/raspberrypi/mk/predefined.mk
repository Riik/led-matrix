...
RPI4_PROFILE_DIR := $(OBJ_DIR)rpi4_profile
HOST_TEST_DIR := $(OBJ_DIR)host_test
HOST_DEBUG_DIR := $(OBJ_DIR)host_debug
HOST_RELEASE_DIR := $(OBJ_DIR)host_release
HOST-DEBUG-LIBS := -lncurses -lgpiod
HOST-RELEASE-LIBS := -lncurses -lgpiod
HOST-TEST-LIBS :=-lgtest -lgtest_main -lgmock -lncurses -lgpiod
RPI4-DEBUG-LIBS :=
RPI4-RELEASE-LIBS :=
RPI4-PROFILE-LIBS :=
