...
ODIRS += $(2DGLXTESTODIR) $(2DGLXDEBUGODIR) $(2DGLXRELEASEODIR)
...
2DGLXTEST_OFILES := $(patsubst $(2DGLXSRC)%,$(2DGLXTESTODIR)%,$(patsubst %.cpp,%.cpp.o,$(2DGLXCXXFILES)))
2DGLXTEST_OFILES += $(patsubst $(2DGLXSRC)%,$(2DGLXTESTODIR)%,$(patsubst %.cpp,%.cpp.o,$(2DGLXTESTCXXFILES)))
RELEASE_OFILES += $(2DGLXRELEASE_OFILES)
DEBUG_OFILES += $(2DGLXDEBUG_OFILES)
TEST_OFILES += $(2DGLXTEST_OFILES)
ALLOFILES += $(2DGLXDEBUG_OFILES) $(2DGLXRELEASE_OFILES) $(2DGLXTEST_OFILES)
...
$(2DGLXTESTODIR)%.cpp.o: $(2DGLXSRC)%.cpp | $(2DGLXTESTODIR)
	$(X86-TEST-BUILDRECEIPE)
