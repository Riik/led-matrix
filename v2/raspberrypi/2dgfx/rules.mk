DIR := $(TOP)$(notdir $(shell dirname $(realpath $(lastword $(MAKEFILE_LIST)))))/
...
ODIRS += $(HOSTTESTODIR) $(HOSTDEBUGODIR) $(HOSTRELEASEODIR) $(RPI4DEBUGODIR) $(RPI4RELEASEODIR)
...
ALLOFILES += $(RPI4_RELEASE_OFILES) $(RPI4_DEBUG_OFILES) $(HOST_TEST_OFILES) $(HOST_DEBUG_OFILES) $(HOST_RELEASE_OFILES)
